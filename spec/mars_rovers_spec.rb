...
describe MarsRovers do
  let(:input) { "5 5\n1 2 N\nLMLMLMLMM\n3 3 E\nMMRMMRMRRM" }
  let(:mars_rover_navigation_and_set) { described_class.new(input) }
  let(:input_array) { mars_rover_navigation_and_set.input }
  ...
  describe 'Input' do
    ...
    describe '#plateau_upper_right_coordinates' do
      let(:plateau_upper_right_coordinates) { mars_rover_navigation_and_set.plateau_upper_right_coordinates }
